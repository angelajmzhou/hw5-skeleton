...
createHashTable:
	...
	mov rax, 8				//size of hashbucket pointer
	mul [rsp]				//hashbucket * size
	mov rsi, 1
	...
	mov [r12+8], [rsp+12]	//newTable->equalFunction = equalFunction;
...
insertData:
	...
	mov [r12+16], [r10+rdx*8]		//newBucket->next = table->data[location]

	mov [r12+8], [rsp+16]			//newBucket -> data = data	
	mov [r12], [rsp+8]				//newBucket -> key = key

	mov [r10+rdx*8], r12			//table->data[location] = newBucket

	mov r10, [rsp]					//deref hashTable
	add [r10+28], 1					//hashTable->used+=1
...
findData:
	...
	//get hashFunction
	mov r10, [rsp]					//deref to get hashtable
	mov r10, [r10]					//deref to get hashFunction
...
//  struct HashBucket *lookAt = table->data[location];
	...
	mov r12, [r10+rdx*8]			//lookAt = table->data[location]
